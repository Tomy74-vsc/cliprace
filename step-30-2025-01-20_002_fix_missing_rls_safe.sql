-- =====================================================
-- Migration: 2025-01-20_002_fix_missing_rls_safe.sql
-- Description: Activer RLS sur les tables de modération manquantes (version sécurisée)
-- =====================================================

-- Vérifier et activer RLS sur moderation_queue si pas déjà activé
DO $$
BEGIN
    IF NOT EXISTS (
...
-- Vérifier et activer RLS sur moderation_rules si pas déjà activé
DO $$
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_tables 
...
-- =====================================================
-- FONCTION POUR INSÉRER DANS AUDIT_LOGS (SERVICE-ROLE)
-- =====================================================
