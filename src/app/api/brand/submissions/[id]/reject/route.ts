...
export async function POST(
  ...
  try {
    ...
    if (updateError) {
      ...
      return NextResponse.json({ error: "Erreur lors du rejet de la participation" }, { status: 500 });
    }
    ...
    console.error("Error in POST /api/brand/submissions/[id]/reject:", error);
