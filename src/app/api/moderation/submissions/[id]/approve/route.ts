/**
 * API pour approuver une submission
 * 
 * Endpoint: POST /api/moderation/submissions/[id]/approve
 */
...
export async function POST(
  ...
  try {
    ...
    // Vérifier que l'utilisateur peut approuver cette submission
    ...
    if (updateError) {
      logger.error('Error approving submission:', updateError);
    ...
    logger.error('Approve submission error:', error instanceof Error ? error : new Error(String(error)));
