...
import { Search, Bell, User, LogOut, Settings, ChevronDown, Building2 } from "lucide-react";
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-zinc-200/50 bg-white/95 backdrop-blur-sm dark:border-zinc-800/50 dark:bg-zinc-900/95">
      <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between px-4">
        {/* Logo */}
        <Link href="/brand" className="inline-flex items-center gap-3">
          ...
          <span className="text-xs font-medium text-zinc-500 bg-zinc-100 px-2 py-1 rounded-full dark:bg-zinc-800">
            Marque
          </span>
        </Link>
