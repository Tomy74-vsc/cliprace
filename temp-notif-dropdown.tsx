/*
Notifications dropdown : affiche les notifs non lues + acc̬s page liste.
*/
'use client';
...
export function NotificationsDropdown() {
  ...
  useEffect(() => {
    ...
    const links = panelRef.current?.querySelectorAll<HTMLAnchorElement>('a[data-notification-item]');
...
function notificationTitle(type: string) {
  switch (type) {
    case 'submission_approved':
      return 'Participation accept̩e';
    case 'submission_rejected':
      return 'Participation refus̩e';
